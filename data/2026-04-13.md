...
### [7] [How Should Video LLMs Output Time? An Analysis of Efficient Temporal Grounding Paradigms](https://arxiv.org/abs/2604.08966)
...
### [8] [ActFER: Agentic Facial Expression Recognition via Active Tool-Augmented Visual Reasoning](https://arxiv.org/abs/2604.08990)
...
### [9] [PinpointQA: A Dataset and Benchmark for Small Object-Centric Spatial Understanding in Indoor Videos](https://arxiv.org/abs/2604.08991)
...
### [10] [Leave My Images Alone: Preventing Multi-Modal Large Language Models from Analyzing Images via Visual Prompt Injection](https://arxiv.org/abs/2604.09024)
...
### [11] [Skill-Conditioned Visual Geolocation for Vision-Language](https://arxiv.org/abs/2604.09025)
...
### [12] [SiMing-Bench: Evaluating Procedural Correctness from Continuous Interactions in Clinical Skill Videos](https://arxiv.org/abs/2604.09037)
...
### [13] [Learning Vision-Language-Action World Models for Autonomous Driving](https://arxiv.org/abs/2604.09059)
...
### [14] [Arbitration Failure, Not Perceptual Blindness: How Vision-Language Models Resolve Visual-Linguistic Conflicts](https://arxiv.org/abs/2604.09364)
...
### [15] [VL-Calibration: Decoupled Confidence Calibration for Large Vision-Language Models Reasoning](https://arxiv.org/abs/2604.09529)
...
### [16] [Long-SCOPE: Fully Sparse Long-Range Cooperative 3D Perception](https://arxiv.org/abs/2604.09206)
...
### [17] [SHIFT: Steering Hidden Intermediates in Flow Transformers](https://arxiv.org/abs/2604.09213)
...
### [18] [Neural Distribution Prior for LiDAR Out-of-Distribution Detection](https://arxiv.org/abs/2604.09232)
...
### [20] [VAGNet: Vision-based accident anticipation with global features](https://arxiv.org/abs/2604.09305)
...
### [21] [EpiAgent: An Agent-Centric System for Ancient Inscription Restoration](https://arxiv.org/abs/2604.09367)
...
### [22] [Do Vision Language Models Need to Process Image Tokens?](https://arxiv.org/abs/2604.09425)
...
### [23] [Realizing Immersive Volumetric Video: A Multimodal Framework for 6-DoF VR Engagement](https://arxiv.org/abs/2604.09473)
...
### [24] [RIRF: Reasoning Image Restoration Framework](https://arxiv.org/abs/2604.09511)
...
### [25] [Tango: Taming Visual Signals for Efficient Video Large Language Models](https://arxiv.org/abs/2604.09547)
...
### [26] [SynDocDis: A Metadata-Driven Framework for Generating Synthetic Physician Discussions Using Large Language Models](https://arxiv.org/abs/2604.08555)
...
### [27] [Medical Reasoning with Large Language Models: A Survey and MR-Bench](https://arxiv.org/abs/2604.08559)
...
### [28] [Temperature-Dependent Performance of Prompting Strategies in Extended Reasoning Large Language Models](https://arxiv.org/abs/2604.08563)
...
### [29] [Attention-Based Sampler for Diffusion Language Models](https://arxiv.org/abs/2604.08564)
...
### [30] [Sentiment Classification of Gaza War Headlines: A Comparative Analysis of Large Language Models and Arabic Fine-Tuned BERT Models](https://arxiv.org/abs/2604.08566)
...
### [31] [Multi-User Large Language Model Agents](https://arxiv.org/abs/2604.08567)
...
### [32] [Decomposing the Delta: What Do Models Actually Learn from Preference Pairs?](https://arxiv.org/abs/2604.08723)
...
### [33] [LLMs Underperform Graph-Based Parsers on Supervised Relation Extraction for Complex Graphs](https://arxiv.org/abs/2604.08752)
...
### [34] [Cards Against LLMs: Benchmarking Humor Alignment in Large Language Models](https://arxiv.org/abs/2604.08757)
...
### [35] [MT-OSC: Path for LLMs that Get Lost in Multi-Turn Conversation](https://arxiv.org/abs/2604.08782)
...
### [36] [MedConceal: A Benchmark for Clinical Hidden-Concern Reasoning Under Partial Observability](https://arxiv.org/abs/2604.08788)
...
### [37] [GRASP: Grounded CoT Reasoning with Dual-Stage Optimization for Multimodal Sarcasm Target Identification](https://arxiv.org/abs/2604.08879)
...
### [38] [Towards Real-world Human Behavior Simulation: Benchmarking Large Language Models on Long-horizon, Cross-scenario, Heterogeneous Behavior Traces](https://arxiv.org/abs/2604.08362)
...
### [39] [MuTSE: A Human-in-the-Loop Multi-use Text Simplification Evaluator](https://arxiv.org/abs/2604.08947)
...
### [40] [TaxPraBen: A Scalable Benchmark for Structured Evaluation of LLMs in Chinese Real-World Tax Practice](https://arxiv.org/abs/2604.08948)
...
### [41] [Breaking Block Boundaries: Anchor-based History-stable Decoding for Diffusion Large Language Models](https://arxiv.org/abs/2604.08964)
...
### [42] [Quantisation Reshapes the Metacognitive Geometry of Language Models](https://arxiv.org/abs/2604.08976)
*Jon-Paul Cacioli*
...
### [43] [PerMix-RLVR: Preserving Persona Expressivity under Verifiable-Reward Alignment](https://arxiv.org/abs/2604.08986)
...
### [44] [ASTRA: Adaptive Semantic Tree Reasoning Architecture for Complex Table Question Answering](https://arxiv.org/abs/2604.08999)
...
### [45] [CONDESION-BENCH: Conditional Decision-Making of Large Language Models in Compositional Action Space](https://arxiv.org/abs/2604.09029)
...
### [46] [NyayaMind- A Framework for Transparent Legal Reasoning and Judgment Prediction in the Indian Legal System](https://arxiv.org/abs/2604.09069)
...
### [47] [Hierarchical Alignment: Enforcing Hierarchical Instruction-Following in LLMs through Logical Consistency](https://arxiv.org/abs/2604.09075)
...
### [50] [ScheMatiQ: From Research Question to Structured Data through Interactive Schema Discovery](https://arxiv.org/abs/2604.09237)
...
### [56] [RecaLLM: Addressing the Lost-in-Thought Phenomenon with Explicit In-Context Retrieval](https://arxiv.org/abs/2604.09494)
...
### [57] [BERT-as-a-Judge: A Robust Alternative to Lexical Methods for Efficient Reference-Based LLM Evaluation](https://arxiv.org/abs/2604.09497)
...
### [58] [Many Ways to Be Fake: Benchmarking Fake News Detection Under Strategy-Driven AI Generation](https://arxiv.org/abs/2604.09514)
...
TL;DR: 提出首个针对物理人机交互（pHRI）应用的生成式仿真框架，实现从文本提示自动合成多样化场景、大规模数据收集与零样本仿真到现实迁移。


<details>
  <summary>Details</summary>
Motivation: 开发自主物理人机交互系统面临大规模训练数据稀缺的瓶颈，限制了机器人行为学习以适应现实世界应用需求。

Method: 基于LLM和VLM的"文本到仿真再到现实"生成框架：流程化生成软体人体模型、场景布局、机器人运动轨迹；自动收集大规模合成演示数据集；训练基于分割点云的视觉模仿学习策略。

Result: 在抓挠和洗澡两项物理辅助任务的用户研究中，学习策略成功实现零样本仿真到现实迁移，成功率超过80%，并展现出对非脚本化人类运动的韧性。

Conclusion: 这是首个pHRI应用的生成式仿真流程，实现了仿真环境合成、数据收集和策略学习的自动化，为自主物理人机交互系统提供了新的数据驱动解决方案。
...
### [60] [AssemLM: Spatial Reasoning Multimodal Large Language Models for Robotic Assembly](https://arxiv.org/abs/2604.08983)
...
### [61] [GNN-as-Judge: Unleashing the Power of LLMs for Graph Learning with GNN Feedback](https://arxiv.org/abs/2604.08553)
*Ruiyao Xu,Kaize Ding*

Main category: cs.LG

TL;DR: 提出GNN-as-Judge框架，通过结合GNN的结构归纳偏置和LLM的语义理解能力，在低资源文本属性图上进行少样本半监督学习，解决伪标签生成和噪声问题


<details>
  <summary>Details</summary>
Motivation: LLM在文本属性图（TAG）上表现优异，但在低资源场景下（标注数据稀缺、结构复杂）效果受限。主要挑战：1）为LLM生成和选择可靠伪标签困难；2）使用伪标签微调LLM时需要缓解潜在标签噪声

Method: GNN-as-Judge框架：1）协作伪标注策略——从标注节点识别最受影响的未标注节点，利用LLM与GNN之间的共识与分歧模式生成可靠标签；2）弱监督LLM微调算法——从信息丰富的伪标签中蒸馏知识并缓解标签噪声

Result: 在多个TAG数据集上的实验表明，GNN-as-Judge显著优于现有方法，特别是在标注数据稀缺的低资源场景中表现突出

Conclusion: 通过融合GNN的结构归纳偏置和LLM的语义理解能力，该框架有效解决了低资源TAG场景下的伪标签生成和噪声问题，证明了其在少样本半监督学习中的优越性
...
### [62] [QuanBench+: A Unified Multi-Framework Benchmark for LLM-Based Quantum Code Generation](https://arxiv.org/abs/2604.08570)
...
### [63] [Robust Reasoning Benchmark](https://arxiv.org/abs/2604.08571)
...
### [64] [Structured Exploration and Exploitation of Label Functions for Automated Data Annotation](https://arxiv.org/abs/2604.08578)
...
### [67] [Efficient RL Training for LLMs with Experience Replay](https://arxiv.org/abs/2604.08706)
...
### [68] [Every Response Counts: Quantifying Uncertainty of LLM-based Multi-Agent Systems through Tensor Decomposition](https://arxiv.org/abs/2604.08708)
...
### [69] [Dictionary-Aligned Concept Control for Safeguarding Multimodal LLMs](https://arxiv.org/abs/2604.08846)
...
### [70] [Uncertainty-Aware Transformers: Conformal Prediction for Language Models](https://arxiv.org/abs/2604.08885)
...
### [71] [Bridging SFT and RL: Dynamic Policy Optimization for Robust Reasoning](https://arxiv.org/abs/2604.08926)
...
### [72] [The nextAI Solution to the NeurIPS 2023 LLM Efficiency Challenge](https://arxiv.org/abs/2604.09034)
...
### [73] [Integrated electro-optic attention nonlinearities for transformers](https://arxiv.org/abs/2604.09512)
...
### [74] [Toward World Models for Epidemiology](https://arxiv.org/abs/2604.09519)
...
### [75] [From Business Events to Auditable Decisions: Ontology-Governed Graph Simulation for Enterprise AI](https://arxiv.org/abs/2604.08603)
...
### [76] [RAMP: Hybrid DRL for Online Learning of Numeric Action Models](https://arxiv.org/abs/2604.08685)
...
### [77] [Model Space Reasoning as Search in Feedback Space for Planning Domain Generation](https://arxiv.org/abs/2604.08712)
...
### [82] [SAGE: A Service Agent Graph-guided Evaluation Benchmark](https://arxiv.org/abs/2604.09285)
...
### [83] [Constraint-Aware Corrective Memory for Language-Based Drug Discovery Agents](https://arxiv.org/abs/2604.09308)
...
### [84] [E3-TIR: Enhanced Experience Exploitation for Tool-Integrated Reasoning](https://arxiv.org/abs/2604.09455)
...
### [85] [SUPERNOVA: Eliciting General Reasoning in LLMs with Reinforcement Learning on Natural Instructions](https://arxiv.org/abs/2604.08477)
